...
public class UserServiceImpl implements UserService,  UserDetailsService{
    ...
    @Override
    public GetNicknameResponse getNickname(final JwtToken jwtToken) {
        String username = JwtDecoder.getClaimStringByKeyFromAccessToken(jwtToken.getAccessToken(), "username");
        User user  = userDao.findUserByUsername(username)
                .orElseThrow(() -> new NotFoundQueryResultException("아이디에 해당하는 유저정보가 없습니다."));
