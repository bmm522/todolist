...
public class JwtGenerator {
   ...
   */
  public JwtToken make(final Long userId, final String username, final String tokenPrefix, final String refreshPrefix, final String iss, final String secretKey) {
  ...
  private String makeAccessToken(final Long userId, final String username, final String tokenPrefix,  final String iss, final String secretKey) {
  ...
  public String makeRefreshToken( final String username, final String refreshPrefix, final String iss, final String secretKey) {
