...
public class TodoUpdateRequest {
  ...
  public static TodoUpdateRequest create(final Long todoId, final String todoTitle, final String todoContent,
      final LocalDateTime todoAt,
      final Status todoDone, final Long userId) {
    return new TodoUpdateRequest(todoId, todoTitle, todoContent, todoAt, todoDone, userId);
  }
