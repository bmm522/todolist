...
public class TodoController {
        ...
        public ApiResponse<TodoGetResponse> getTodoList(
            ...
            @CurrentUserId Long userId) {
                ...
                return ApiResponse.success(HttpStatus.OK,
                    todoService.getTodoGroupingMap(dto, userId));
        }
         ...
         *
         * @param request 일괄 업데이트할 할일 아이디 리스트와 업데이트할 완료 상태를 담은 TodoBatchUpdateTodoDoneClientRequest
         *                객체
        ...
        public ApiResponse<Integer> batchUpdateTodoDone(
            ...
            @PathVariable("isDone") Status isDone, @CurrentUserId Long userId) {
                ...
                TodoBatchUpdateTodoDoneRequest dto = TodoServiceDtoConverter.of(request, isDone,
                    userId);
